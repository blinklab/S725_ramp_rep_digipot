...
trials.eye(metadata.eye.trialnum2).stimtime.st{2}=metadata.stim.c.isi+(metadata.stim.c.cs_addreps*metadata.stim.c.cs_period);;
...
trials.eye(metadata.eye.trialnum2).isi=metadata.stim.c.isi+(metadata.stim.c.cs_addreps*metadata.stim.c.cs_period);
