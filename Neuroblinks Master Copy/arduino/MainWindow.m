...
switch lower(metadata.stim.type)
    ...
    case 'conditioning'
        ...
        metadata.stim.c.tonecs_intensity=trialvars(18); %%%Olivia 6/4/2020
...
elseif  strcmpi(metadata.stim.type, 'conditioning')
    ...
    prevtoneint = getappdata(0,'prevtoneint');
    if prevtoneint==metadata.stim.c.tonecs_intensity
        datatoarduino(19) = 0; % Olivia added 6/4/2020 for testing addition of tone to code
    else
        datatoarduino(19) = 1; % Olivia added 6/4/2020 for testing addition of tone to code
    end
    setappdata(0,'prevtoneint',metadata.stim.c.tonecs_intensity)
