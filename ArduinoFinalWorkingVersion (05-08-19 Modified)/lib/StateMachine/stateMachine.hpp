...
class StateMachine {
    ...
    public:
        ...
        //void refreshNumRepeats(); // added these lines to fix problem preventing trials > 5s from running. Notes are in kimoli's 2/17/2020 commit to the neuroblinks_S725 repository
        int checkState();
